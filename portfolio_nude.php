...
<html lang="en">
    <head>
        <title>Portfolio - Nude Art</title>
       <?php
            include './head.php';
        ?>
    </head>
                ...
                <div class="container">
                    <div class="gallery gall__1">
                        <div class="row">
                            ...
                            <div class="clear"></div>
                            <?php
                            $dir_bigfiles = "images/gallery/big/nude/";
                            $dir_thumbs = "images/gallery/thumbs/nude/";

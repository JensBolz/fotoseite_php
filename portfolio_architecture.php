    ...
    <body class="" id="top" oncontextmenu="return false">
        ...
        <header>
            <div id="stuck_container">
                            ...
                            <div class="menu_block ">
                                <nav class="horizontal-nav full-width horizontalNav-notprocessed">
                                    <ul class="sf-menu">
                                        ...
                                        <li class="current">Architektur</li>
                ...
                <div class="block1">Architektur</div>  
            </div>
        </header>
        <div class="main">
            <!--=====================Content======================-->
                ...
                <div class="container">
                    <div class="gallery gall__1">
                        <div class="row">
                            ...
                            <div class="clear"></div>
                            <?php
                            $dir_bigfiles = "images/gallery/big/architecture/";
                            $dir_thumbs = "images/gallery/thumbs/architecture/";
